 ...
 *    }
 *    class Foo extends Disposable(Object) {
 *      create(...args) { ...constructor work... }      // Instead of constructor, if needed.
 *    }
 *
 * To create Foo:
...
const Disposable = _cachingFunc(superClass => class extends superClass {
  ...
  constructor(...args) {
    ...
    try {
      ...
      try {
        ...
        console.error("Error cleaning up partially constructed %s:", this.constructor.name, e);
      }
      throw e;
    }
  }
