...
class Emitter {
  ...
  /**
   * Set the single callback that would get called when a listener is added or removed.
  ...
  /**
   * Disposes the Emitter. It breaks references between the emitter and the callbacks, allowing
